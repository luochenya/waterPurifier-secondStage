...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "/searchProductsDetails", // 產品詳情頁 
        name: "searchProductsDetails",
        component: () => import("@/views/searchProductsDetails")
      },
      {
  ...
  {
    path: "/lineBind", // line绑定好友
    name: "lineBind",
    component: () => import("@/views/LoginRegister/lineBind")
  },
  {
    path: "/PhoneVerification", // 手机验证
    name: "PhoneVerification",
    component: () => import("@/views/LoginRegister/PhoneVerification")
  },
  {
    path: "/sakuraMember", // 会员
    name: "sakuraMember",
    component: () => import("@/views/LoginRegister/sakuraMember")
  },
  {
    path: "/registered", // 注册
    name: "registered",
    component: () => import("@/views/LoginRegister/registered")
  }
];
